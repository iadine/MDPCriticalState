...
% Source: Chadès I., Curtis J.M.R, Martin T.G. (2012) Setting realistic 
...
for j=1:nb_simu
    ...
    for i=1:T
        ...
        AbaPop(j,i)=sum(N1(6:end))/PARAM_ABALONE.area;
    end
end
...
for j=1:nb_simu
    ...
    for i=1:T
        ...
        Aba(j,i)=sum(N1(6:end))/PARAM_ABALONE.area;
    end
end
