...
function abalone_study()
% Global variables
clear
global PARAM_ABALONE PARAM_QL PARAM_POACHING G Ginit INIT_N
...
for j=1:nb_simu
    ...
    for i=1:T
        ...
        AbaPop(j,i)=sum(N1)/PARAM_ABALONE.area;
    end
end
...
for j=1:nb_simu
    ...
    for i=1:T
        ...
        AbaPop(j,i)=sum(N1)/PARAM_ABALONE.area;
        AbaAdult(j,i)=sum(N1(6:end))/PARAM_ABALONE.area;
    end
end
...
for j=1:nb_simu
    ...
    for i=1:T
        ...
        Aba(j,i)=sum(N1)/PARAM_ABALONE.area;
    end
end
