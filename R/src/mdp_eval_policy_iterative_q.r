# function Vpolicy = mdp_eval_policy_iterative_q(P, R, discount, policy, V0, epsilon, max_iter)

mdp_eval_policy_iterative_q <- function(P, R, discount, policy, V0, epsilon, max_iter) {
  
  #  mdp_eval_policy_iterative_q   Policy evaluation using iteration. 
  #  Arguments -------------------------------------------------------------
  ...
  #    Q(SxA) = Q value associated to a specific policy
  # --------------------------------------------------------------------------
  ...
  if ( discount <= 0 | discount > 1 ) {
    ...
    x = mdp_bellman_operator_q(P, PR, discount, Vpolicy);
    
  }
  return(list( "Vpolicy"=Vpolicy, "Q"=x$Q))
